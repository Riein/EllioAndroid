...
import app.novaci.com.framework.util.Animation;
import app.novaci.com.framework.util.Frame;
...
public class Assets {
    ...
    public static void initializeRecentAPISoundPool() {
